...
export const translations = {
  en: {
    ...
    // Contact Page New
    contactTagline: 'Get in touch with us',
    headOffice: 'Head Office',
    headOfficeAddress: 'Matunga Road, Mumbai, Maharashtra',
    phoneNumbers: 'Phone Numbers',
    emailLabel: 'Email',
    businessHours: 'Business Hours',
    hoursWeekdays: 'Mon - Fri: 10:00 AM - 5:00 PM',
    hoursSaturday: 'Sat: 10:00 AM - 2:00 PM',
    hoursSunday: 'Sun: Closed',
    connectWithUsShort: 'Connect With Us',
  ...
  mr: {
    ...
    // Contact Page New
    contactTagline: 'आमच्याशी संपर्क साधा',
    headOffice: 'मुख्यालय',
    headOfficeAddress: 'मातुंगा रोड, मुंबई, महाराष्ट्र',
    phoneNumbers: 'फोन क्रमांक',
    emailLabel: 'ईमेल',
    businessHours: 'व्यवसाय वेळा',
    hoursWeekdays: 'सोम - शुक्र: १०:०० ते ५:००',
    hoursSaturday: 'शनिवार: १०:०० ते २:००',
    hoursSunday: 'रविवार: बंद',
    connectWithUsShort: 'आमच्याशी जोडा',
    ...
    subjectLabel: 'विषय',
    messageLabel: 'संदेश',
    placeholderFullName: 'तुमचे पूर्ण नाव लिहा',
    placeholderEmail: 'तुमचा ईमेल लिहा',
    placeholderPhone: 'तुमचा फोन नंबर लिहा',
    placeholderSubject: 'कशाबद्दल आहे?',
    placeholderMessage: 'तुमचा संदेश लिहा',
    submitMessage: 'संदेश पाठवा',
    sending: 'पाठवत आहे...',
  }
};
